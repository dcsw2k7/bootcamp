public class DemoOverloading {
  ...
  // Methon Signature = method name + parameter(s)
  ...
  public static void sum(Object x, Object y) {
    System.out.println("caling void sum(Object x, Object y)");
  }
  ...
  public static void main(String[] args) {
    ...
    sum(new Cat(), new Dog());  // calling void sum(Amimal x, Amimal y)

    // what is the method paramters are with type of Wrapper Class?
    // You try it out.
