public class DemoOverriding {  // dynamic polymorphism (run-time)
  ...
  public static void main(String[] args) {
    ...
    // Durning runtime, the new cat object is created in heap memory,
    ...
    // Durning runtime, the new cat object is created in heap memory,
    // then the object ref "animal2" will point cat object and execute walk() method.
    // That is Animal.walk()

    // Example 3
    animal = new Dog();
    // amimal.sleep();  // compile-error, because the object reference type determined the scope of the object.
