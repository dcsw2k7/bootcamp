...
public class ArrayListDemo {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(integers2.subList(1, 3));  // from index 1 ti index 2 -> [-100, 2]
        ...
        // You can skip the type declaration when you create the arrylist object
        // by default is follow the type specified at the left hand side
        ...
        for (String s : stringArray) {
            if (s!=null && s.length() > 3 ) {  /* 特別處理null   s!=null 先CHECK不是null  */
                result.add(s);
            }
        }
        System.out.println(result);  // ["aaaa"]

        // Question 2 : Given Person[], retrieve all customer object with age > 30 or name startsWith "J"
