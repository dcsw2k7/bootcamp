...
public class SmallBall extends Ball {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(b2.equals(b3));  // ture
    ...
    System.out.println(b1);  // SmallBall(color=RED,Ball(number1))
    System.out.println(b2);  // SmallBall(color=ORANGE,Ball(number2))
    System.out.println(b3);  // SmallBall(color=ORANGE,Ball(number2))
