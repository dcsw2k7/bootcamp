...
public class DemoObject {
    public static void main(String[] args) {
       ...
       Object object = new Object();  // Object is a super parent (ultr ) 萬能指針 
       /* 可指放任何東西(但其方法不保可執行,如兩者不同等 如時間 與 重量，兩者無法比對加或運算) */
       object = "abc";
       object = Double.valueOf(13);
       object = new Cat();

       // All Classes extends Object.class. Inherit all methods form Objet.class
       // System.out.println(new Cat().toString());  // Cat@5fd0d5ae
       System.out.println(new Cat().toString());  // I am a cat
       System.out.println(new Dog().toString());  // Dog@2d98a335

       // Object.hashCode()
       Cat c1 = new Cat();
       System.out.println(c1.hashCode()); // 381259350 
       // genrate an int value by object
       // reference -> 19kcvjkjc
       Cat c2 = new Cat();
    ...
    /* Object cat = new Dog() */
    /* cat 物件 是指向dog,但用不用到要看兩都本身是否可運算*/
    /* objet 指針 與 objet Method */
    Object cat = new Cat();
    ...
    // downcast
    Cat cat2 = (Cat) cat;  // Rason why compile error: Java compiler cannot guareete
    cat2.run();
    ...
    /* (JAVA要先看TYPE才會幫你處理,即是方法可不可用也先看TYPE) */
    ...
    // During compile time, Compiler cannot ensure the object in heap is a String objeect
