...
public class StringDemo {
  public static void main(String[] args) {
    /* String */
    String s = "hello";
    String s2 = s.concat("world");  // concat() method return new String Object, no impact to s
    ...
    sb.append("world");  // You don't have to "save" the address of sb. because you alreay changed the value stored /* 不接著自己改自己 */
