public enum Direction {
  ...
  public Direction oopsite() {
    for (Direction direction : Direction.values()) {  /* loop 尋找 */ 
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Direction.EAST.isOppsite(WEST));  // true
    System.out.println(Direction.EAST.isOppsite(NORTH));  // false
    ...
    System.out.println(Direction.oppsite(Direction.SOUTH));  // 
    System.out.println(Direction.oppsite(Direction.WEST));  // 
